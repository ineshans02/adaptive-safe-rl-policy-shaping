...
sys.path.append('/home/usladmin/Overcoming-exploration-from-demos2/')
...
def train(policy, rollout_worker, evaluator,
    ...
    #print("policy.bc_loss:",policy.bc_loss)
...
def launch(
    ...
    policy_shaping=False, d_threshold=0.15,
...
@click.option('--demo_file', type=str, default='/home/ineshans/Learning-from-Failure-for-Robotic-Arms/data_generation/data_fetch_random_100_randombad.npz', help='failed experience data file path')
@click.option('--policy_shaping', is_flag=True, default=False, help='enable policy shaping safety mechanism')
@click.option('--d_threshold', type=float, default=0.15, help='safety activation distance in metres')
def main(**kwargs):
    launch(**kwargs)
