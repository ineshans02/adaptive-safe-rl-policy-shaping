...
| FetchReach-v1 | Move gripper to goal | Easy — Sanity check |
| FetchSlide-v1 | Hit a puck across a table | Hard — Bonus |
...
├── results/
│   ├── lfe_single_graph.png         ← LFE baseline learning curves (all 4 envs)
│   ├── lfe_baseline_curves.png      ← LFE baseline verification curves
...
## Baseline Results (Verification Run)

50 epochs, 1 seed, 10 MPI workers — confirms LFE implementation works correctly.

| Environment | Final Success Rate | Best Success Rate |
|-------------|-------------------|-------------------|
| FetchReach | 99% | 100% |
| FetchPush | 98% | 100% |
| FetchPickAndPlace | 46% | 55% |
| FetchSlide | 36% | 39% |

![LFE Baseline Learning Curves](results/lfe_single_graph.png)
